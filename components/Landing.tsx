      ...
      <div className="3xl:top-[450px] absolute left-[100px] z-10 text-white">
        ...
        <div className="flex flex-col gap-8 p-8">
          ...
          <ul className="ml-7 flex list-disc flex-col gap-2">
            <li className="font-nunito text-2xl text-cyan-900">{t("text1")}</li>
            <li className="font-nunito text-2xl text-cyan-900">{t("text2")}</li>
            <li className="font-nunito text-2xl text-cyan-900">{t("text3")}</li>
          </ul>
