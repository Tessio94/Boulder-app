...
const EventsForm = () => {
  return (
    <div className="mx-[20px] mb-[50px] flex flex-col gap-12 rounded-2xl bg-cyan-900/10 px-[16px] py-[50px] sm:mx-[50px] md:mb-[80px] md:px-[60px] lg:mx-[60px] 2xl:mx-[160px]">
      <button className="bg-cards hover:bg-cards-dark active:bg-cards-dark focus:bg-cards-dark w-fit rounded-2xl px-6 py-2 text-3xl text-cyan-900 hover:text-cyan-800 focus:text-cyan-800 active:text-cyan-800">
        Sort
      </button>
